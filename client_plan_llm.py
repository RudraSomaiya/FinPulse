...
def _build_prompt(ctx: Dict[str, Any]) -> str:
    ...
    parts.append(
        ...
        "    - Upside: <1–2 very short phrases on benefits (e.g., higher return potential, diversification)>\n"
        "    - Downside: <1–2 very short phrases on risks (e.g., volatility, capital loss risk)>\n"
        "Ensure each bullet is on its own line; do NOT merge everything into a single sentence.\n\n"
        "------------------------------\n"
